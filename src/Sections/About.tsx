    ...
    return (
        <ContainerSection>
            ...
            <p className='pt-8 max-lg:pt-4 max-md:text-base font-light text-lg leading-6'>
                ...
                e sou um desenvolvedor front-end com um toque de paixão pelo design.Combinando a minha habilidade técnica com
                uma visão artística, busco trazer à vida interfaces interativas que cativam encantam os usuários.
            </p>
